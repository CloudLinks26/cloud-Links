...
export default function HomePageContent() {
  ...
  return (
    <div className="space-y-0">
      ...
      {/* 8. ADVERTISER / BRAND CTA (SECTION D) */}
      <section id="advertiser-cta" className="py-20 bg-[#F5F0E8] relative overflow-hidden border-t border-[#E8E2D6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#FDFAF4] rounded-3xl border border-[#E8E2D6] p-8 sm:p-12 shadow-2xl relative overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
              <div className="lg:col-span-5 space-y-6">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#C89B2A]/20 text-[#1A3C34] text-xs font-black uppercase tracking-wider border border-[#C89B2A]/40">
                  <Sparkles className="w-4 h-4 text-[#C89B2A]" />
                  <span>🏆 Over 500+ Brands Trust LinkX</span>
                </div>

                <div className="relative rounded-2xl overflow-hidden border-2 border-[#E8E2D6] shadow-lg group">
                  <img
                    src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=800"
                    alt="Brands & Advertisers Team"
                    className="w-full h-80 object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1A3C34]/90 via-[#1A3C34]/40 to-transparent flex flex-col justify-end p-6 text-white space-y-1">
                    <span className="font-display font-extrabold text-lg">Performance Marketing Platform</span>
                    <span className="text-xs text-[#E8E2D6]">Zero risk • Pure ROI driven growth</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-7 space-y-6">
                <div className="space-y-3">
                  <h2 className="text-3xl sm:text-4xl font-extrabold font-display text-[#1A3C34] leading-tight">
                    Are You a Brand or Advertiser?
                  </h2>
                  <div className="w-16 h-1 bg-[#C89B2A] rounded-full" />
                  <p className="text-sm sm:text-base text-[#6B6355] leading-relaxed">
                    Looking to reach 10,000+ active Indian creators and drive real sales? LinkX connects your brand with the right audience — and you only pay for actual confirmed results.
                  </p>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-[#F5F0E8] border border-[#E8E2D6]">
                    <CheckCircle2 className="w-5 h-5 text-[#1A3C34] flex-shrink-0" />
                    <span className="text-xs font-bold text-[#1A3C34]">10,000+ Verified Creators</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-[#F5F0E8] border border-[#E8E2D6]">
                    <CheckCircle2 className="w-5 h-5 text-[#1A3C34] flex-shrink-0" />
                    <span className="text-xs font-bold text-[#1A3C34]">Pay Only For Conversions</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-[#F5F0E8] border border-[#E8E2D6]">
                    <CheckCircle2 className="w-5 h-5 text-[#1A3C34] flex-shrink-0" />
                    <span className="text-xs font-bold text-[#1A3C34]">Real-time Analytics Suite</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-[#F5F0E8] border border-[#E8E2D6]">
                    <CheckCircle2 className="w-5 h-5 text-[#1A3C34] flex-shrink-0" />
                    <span className="text-xs font-bold text-[#1A3C34]">Dedicated Account Manager</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                  <button
                    onClick={() => onOpenAuth('signup', 'brand')}
                    className="w-full sm:w-auto px-8 py-4 rounded-xl bg-[#C89B2A] hover:bg-[#b08823] text-[#1A3C34] font-black text-sm transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
                  >
                    <span>Contact Sales</span>
                    <ArrowRight className="w-4 h-4" />
                  </button>
                  <Link
                    href="/about"
                    className="w-full sm:w-auto px-8 py-4 rounded-xl border-2 border-[#1A3C34] text-[#1A3C34] hover:bg-[#1A3C34] hover:text-white font-extrabold text-sm transition-all text-center block cursor-pointer"
                  >
                    Learn More
                  </Link>
                </div>
                ...
                <div className="pt-4 border-t border-[#E8E2D6] space-y-2">
                  <span className="text-xs font-bold text-[#6B6355] block">Trusted by 500+ top brands including:</span>
                  <div className="flex flex-wrap items-center gap-2">
                    {['Amazon', 'Flipkart', 'Myntra', 'Nykaa'].map((b) => (
                      <span key={b} className="px-3 py-1 rounded-lg bg-[#F5F0E8] border border-[#E8E2D6] text-xs font-black text-[#1A3C34]">
                        {b}
                      </span>
                    ))}
                  </div>
      ...
      {/* 5. WHO IS IT FOR */}
      <section id="who-is-it-for" className="py-20 bg-[#F5F0E8] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <h2 className="text-3xl sm:text-4xl font-extrabold font-display text-[#1A3C34]">
              Who Is LinkX For?
            </h2>
            <p className="text-sm sm:text-base text-[#6B6355]">
              Built to connect ambitious Indian creators with top tier brands for high performance monetization.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Card 1 — Publishers / Creators */}
            <div className="bg-[#FDFAF4] rounded-3xl border border-[#E8E2D6] p-8 space-y-6 shadow-warm-hover flex flex-col justify-between">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="p-3.5 bg-[#1A3C34] text-[#C89B2A] rounded-2xl shadow-md flex-shrink-0">
                    <UserCheck className="w-8 h-8" />
                  </div>
                  <div>
                    <span className="text-xs uppercase font-extrabold tracking-wider text-[#C89B2A]">
                      Publishers & Creators
                    </span>
                ...
                {/* Image Container */}
                <div className="w-full aspect-[16/9] bg-[#F5F0E8] rounded-2xl border border-[#E8E2D6] relative overflow-hidden flex items-center justify-center">
                  <img
                    src="https://res.cloudinary.com/dqjlffxja/image/upload/v1786191817/1_vduehk.png"
                    alt="Creators and Influencers working"
                    className="w-full h-full object-contain"
                  />
                  <div className="absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex flex-col items-start gap-1.5">
                ...
                <p className="text-sm text-[#6B6355] leading-relaxed">
                  Monetize your Instagram, YouTube, Telegram channels, WhatsApp groups, or blog with high-paying brand offers.
                </p>

                <ul className="space-y-3 pt-2">
                  <li className="flex items-start gap-3 text-sm text-[#1A3C34] font-medium">
                    <CheckCircle2 className="w-5 h-5 text-[#C89B2A] flex-shrink-0 mt-0.5" />
                    <span>Earn up to 20% commission on every sale</span>
                  </li>
                  <li className="flex items-start gap-3 text-sm text-[#1A3C34] font-medium">
                    <CheckCircle2 className="w-5 h-5 text-[#C89B2A] flex-shrink-0 mt-0.5" />
                    <span>500+ top Indian brands to promote instantly</span>
                  </li>
                  <li className="flex items-start gap-3 text-sm text-[#1A3C34] font-medium">
                    <CheckCircle2 className="w-5 h-5 text-[#C89B2A] flex-shrink-0 mt-0.5" />
                    <span>Real-time live earnings dashboard</span>
                  </li>
                  <li className="flex items-start gap-3 text-sm text-[#1A3C34] font-medium">
                    <CheckCircle2 className="w-5 h-5 text-[#C89B2A] flex-shrink-0 mt-0.5" />
                    <span>Instant payout via UPI / Bank Transfer</span>
                  </li>
                </ul>
              </div>
              ...
              <button
                onClick={() => onOpenAuth('signup', 'creator')}
                className="w-full py-4 px-6 rounded-2xl bg-[#C89B2A] hover:bg-[#b08823] text-[#1A3C34] font-extrabold text-sm transition-all shadow-md flex items-center justify-center gap-2 group mt-6 cursor-pointer"
              >
            ...
            {/* Card 2 — E-Commerce & Merchants */}
            <div className="bg-[#FDFAF4] rounded-3xl border border-[#E8E2D6] p-8 space-y-6 shadow-warm-hover flex flex-col justify-between">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="p-3.5 bg-[#1A3C34] text-white rounded-2xl shadow-md flex-shrink-0">
                    <Megaphone className="w-8 h-8" />
                  </div>
                  <div>
                    <span className="text-xs uppercase font-extrabold tracking-wider text-[#1A3C34]">
                ...
                <div className="w-full aspect-[16/9] bg-[#F5F0E8] rounded-2xl border border-[#E8E2D6] relative overflow-hidden flex items-center justify-center">
                  <img
                    src="https://res.cloudinary.com/dqjlffxja/image/upload/v1786191818/2_yt40ae.png"
                    alt="Brands and Marketing strategy"
                    className="w-full h-full object-contain"
                  />
                  <div className="absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex flex-col items-start gap-1.5">
                ...
                <p className="text-sm text-[#6B6355] leading-relaxed">
                  Scale your sales with performance-based creator marketing. Zero upfront ad spend — pay only when sales occur.
                </p>

                <ul className="space-y-3 pt-2">
                  <li className="flex items-start gap-3 text-sm text-[#1A3C34] font-medium">
                    <CheckCircle2 className="w-5 h-5 text-[#1A3C34] flex-shrink-0 mt-0.5" />
                    <span>Reach 10,000+ active Indian creators and publishers</span>
                  </li>
                  <li className="flex items-start gap-3 text-sm text-[#1A3C34] font-medium">
                    <CheckCircle2 className="w-5 h-5 text-[#1A3C34] flex-shrink-0 mt-0.5" />
                    <span>Pay purely for actual confirmed conversions</span>
                  </li>
                  <li className="flex items-start gap-3 text-sm text-[#1A3C34] font-medium">
                    <CheckCircle2 className="w-5 h-5 text-[#1A3C34] flex-shrink-0 mt-0.5" />
                    <span>Full campaign analytics dashboard with fraud detection</span>
                  </li>
                  <li className="flex items-start gap-3 text-sm text-[#1A3C34] font-medium">
                    <CheckCircle2 className="w-5 h-5 text-[#1A3C34] flex-shrink-0 mt-0.5" />
                    <span>Dedicated key account manager for campaign optimization</span>
                  </li>
                </ul>
              </div>
              ...
              <button
                onClick={() => onOpenAuth('signup', 'brand')}
                className="w-full py-4 px-6 rounded-2xl border-2 border-[#1A3C34] hover:bg-[#1A3C34] text-[#1A3C34] hover:text-white font-extrabold text-sm transition-all flex items-center justify-center gap-2 group mt-6 cursor-pointer"
              >
      ...
      {/* 6. WHY LINKX */}
      <section id="why-linkx" className="py-20 bg-[#FDFAF4] border-t border-[#E8E2D6] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#1A3C34]/10 text-[#1A3C34] text-xs font-extrabold uppercase tracking-wider">
              <Sparkles className="w-3.5 h-3.5 text-[#C89B2A]" />
            ...
            <p className="text-base text-[#6B6355]">
              Everything you need to earn more, track transparently, and grow faster.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-[#F5F0E8] rounded-2xl border border-[#E8E2D6] p-6 space-y-4 hover:border-[#C89B2A] transition-all duration-300 shadow-warm-hover group"
                >
                  <div className="w-12 h-12 rounded-xl bg-[#1A3C34] text-[#C89B2A] flex items-center justify-center group-hover:scale-105 transition-transform shadow-sm">
                    <Icon className="w-6 h-6" />
                  </div>

                  <h3 className="font-display font-extrabold text-lg text-[#1A3C34]">
                    {item.title}
                  </h3>
