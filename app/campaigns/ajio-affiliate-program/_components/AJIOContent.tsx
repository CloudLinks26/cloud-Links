...
export default function AJIOContent() {
  // AJIO Brand Data
  const brand = {
    name: 'AJIO',
    slug: 'ajio-affiliate-program',
    logo: 'https://res.cloudinary.com/couponsbit/image/upload/v1786965786/5_khkkoh.jpg',
    tagline: 'Fashion That\'s Always On',
    category: 'Fashion',
    type: 'CPS', // Cost Per Sale
    commission: '5%',
    rating: 4.7,
    country: 'India 🇮🇳',
    about: 'AJIO, backed by Reliance Retail, is one of India\'s leading fashion and lifestyle e-commerce platforms, offering a wide range of apparel, footwear, and accessories from top and emerging brands.',
    highlights: [
      '5% commission on every qualifying sale',
      'Reporting Time: Daily / Offline',
      'One of India\'s most recognized fashion platforms',
    ]
  };
            ...
            <div className="lg:w-[38%] bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 text-[#1A3C34] shadow-2xl border border-[#E8E2D6] flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    window.open(
                      "https://analytics.trackier.io/publisher/campaign/4695",
                      "_blank",
                      "noopener,noreferrer"
                    )
                  }
            ...
            <div className="bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 border border-[#E8E2D6] shadow-sm space-y-6">
              <div className="space-y-2">
                ...
                <h2 className="text-2xl sm:text-3xl font-black font-display text-[#1A3C34]">
                  India's Leading Fashion & Lifestyle Destination
                </h2>
              </div>
      ...
      <section className="bg-[#1A3C34] text-white py-20 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10 space-y-6">
          ...
          <p className="text-sm sm:text-base text-[#F5F0E8]/90 font-medium leading-relaxed max-w-xl mx-auto">
            Join CloudsLink and start promoting AJIO's wide range of fashion and lifestyle products while earning commissions on qualifying sales.
          </p>
