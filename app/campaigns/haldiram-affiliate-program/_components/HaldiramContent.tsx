...
export default function HaldiramContent() {
  // Haldiram Brand Data
  const brand = {
    name: 'Haldiram',
    slug: 'haldiram-affiliate-program',
    logo: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1786188928/3_lnmzlc.png',
    tagline: "India's Taste, Trusted Since 1937",
  ...
  onClick={() =>
    window.open(
      "https://analytics.trackier.io/publisher/campaign/4909",
      "_blank",
      "noopener,noreferrer"
    )
  }
            ...
            <div className="bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 border border-[#E8E2D6] shadow-sm space-y-6">
              <div className="space-y-2">
                ...
                <h2 className="text-2xl sm:text-3xl font-black font-display text-[#1A3C34]">
                  India's Iconic Snacks &amp; Sweets Brand
                </h2>
              </div>
