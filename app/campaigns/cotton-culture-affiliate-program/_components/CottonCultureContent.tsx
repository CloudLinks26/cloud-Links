...
export default function CottonCultureContent() {
  // Cotton Culture Brand Data
  const brand = {
    name: 'Cotton Culture',
    slug: 'cotton-culture-affiliate-program',
    logo: 'https://res.cloudinary.com/couponsbit/image/upload/v1786965785/8_h525df.jpg',
    tagline: 'Comfort Woven In',
    category: 'Home & Furnishing',
    type: 'CPS', // Cost Per Sale
    commission: '12%',
    rating: 4.7,
    country: 'India 🇮🇳',
    about: 'Cotton Culture is a home textiles brand known for premium cotton bedsheets, comforters, and furnishing essentials. Combining comfort with everyday design, it\'s a trusted name for Indian households upgrading their bedroom and living spaces.',
    highlights: [
      '12% commission on every qualifying sale',
      'Reporting Time: 72 Hours / Offline',
      'High repeat-purchase category with year-round demand',
    ]
  };
            ...
            <div className="lg:w-[38%] bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 text-[#1A3C34] shadow-2xl border border-[#E8E2D6] flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    window.open(
                      "https://analytics.trackier.io/publisher/campaign/4944",
                      "_blank",
                      "noopener,noreferrer"
                    )
                  }
            ...
            <div className="bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 border border-[#E8E2D6] shadow-sm space-y-6">
              <div className="space-y-2">
                ...
                <h2 className="text-2xl sm:text-3xl font-black font-display text-[#1A3C34]">
                  Premium Cotton Bedding & Home Textiles
                </h2>
              </div>
      ...
      <section className="bg-[#1A3C34] text-white py-20 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10 space-y-6">
          ...
          <p className="text-sm sm:text-base text-[#F5F0E8]/90 font-medium leading-relaxed max-w-xl mx-auto">
            Join CloudsLink and start promoting Cotton Culture's premium bedding and home textiles while earning commissions on qualifying sales.
          </p>
