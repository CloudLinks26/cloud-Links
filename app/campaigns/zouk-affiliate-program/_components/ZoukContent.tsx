...
export default function ZoukContent() {
  // ZOUK Brand Data
  const brand = {
    name: 'ZOUK',
    slug: 'zouk-affiliate-program',
    logo: 'https://res.cloudinary.com/couponsbit/image/upload/v1787058335/Untitled_design_1_xkltpw.webp',
    tagline: 'Handcrafted, Cruelty-Free Style',
    ...
    rating: 4.7,
    country: 'India 🇮🇳',
    about: 'ZOUK is an Indian vegan lifestyle brand known for handcrafted bags, wallets, and accessories made from cruelty-free materials, blending traditional Indian art with sustainable design.',
    highlights: [
      '9% commission on every qualifying sale',
      'Reporting Time: Daily / Offline',
      'Popular gifting category with strong repeat demand',
    ]
  };
            ...
            <div className="lg:w-[38%] bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 text-[#1A3C34] shadow-2xl border border-[#E8E2D6] flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    window.open(
                      "https://analytics.trackier.io/publisher/campaign/3014",
                      "_blank",
                      "noopener,noreferrer"
                    )
                  }
            ...
            <div className="bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 border border-[#E8E2D6] shadow-sm space-y-6">
              <div className="space-y-2">
                ...
                <h2 className="text-2xl sm:text-3xl font-black font-display text-[#1A3C34]">
                  Handcrafted Vegan Bags & Accessories
                </h2>
              </div>
      ...
      <section className="bg-[#1A3C34] text-white py-20 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10 space-y-6">
          ...
          <p className="text-sm sm:text-base text-[#F5F0E8]/90 font-medium leading-relaxed max-w-xl mx-auto">
            Join CloudsLink and start promoting ZOUK's handcrafted vegan accessories while earning commissions on qualifying sales.
          </p>
