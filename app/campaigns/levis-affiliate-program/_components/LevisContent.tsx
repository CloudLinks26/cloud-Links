...
export default function LevisContent() {
  // Levi's Brand Data
  const brand = {
    name: 'Levi\'s',
    ...
    rating: 4.8,
    country: 'India 🇮🇳',
    about: 'Levi\'s is one of the world\'s most iconic denim and apparel brands, known for its classic jeans, jackets, and casual wear. With a legacy spanning over a century, Levi\'s combines timeless style with modern comfort for everyday wardrobes.',
    highlights: [
      '17% commission on every qualifying sale',
      'Reporting Time: 72 Hours / Offline',
      'Globally recognized brand drives strong conversion rates',
    ]
  };
            ...
            <div className="lg:w-[38%] bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 text-[#1A3C34] shadow-2xl border border-[#E8E2D6] flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    window.open(
                      "https://analytics.trackier.io/publisher/campaign/3060",
                      "_blank",
                      "noopener,noreferrer"
                    )
                  }
            ...
            <div className="bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 border border-[#E8E2D6] shadow-sm space-y-6">
              <div className="space-y-2">
                ...
                <h2 className="text-2xl sm:text-3xl font-black font-display text-[#1A3C34]">
                  Timeless Denim, Trusted Worldwide
                </h2>
              </div>
      ...
      <section className="bg-[#1A3C34] text-white py-20 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10 space-y-6">
          ...
          <p className="text-sm sm:text-base text-[#F5F0E8]/90 font-medium leading-relaxed max-w-xl mx-auto">
            Join CloudsLink and start promoting Levi's iconic denim and apparel collection while earning commissions on qualifying sales.
          </p>
