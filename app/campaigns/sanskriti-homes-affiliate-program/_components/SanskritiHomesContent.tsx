...
export default function SanskritiHomesContent() {
  // Sanskriti Homes Brand Data
  const brand = {
    name: 'Sanskriti Homes',
    slug: 'sanskriti-homes-affiliate-program',
    logo: 'https://res.cloudinary.com/couponsbit/image/upload/v1786965785/1_rmbba3.jpg',
    tagline: 'Bringing Home to Life',
    category: 'Home Decor',
    type: 'CPS', // Cost Per Sale
    commission: '17%',
    rating: 4.6,
    country: 'India 🇮🇳',
    about: 'Sanskriti Homes offers thoughtfully designed home decor and furnishing products that blend traditional Indian craftsmanship with contemporary style, helping customers create warm, personalized living spaces.',
    highlights: [
      '17% commission on every qualifying sale',
      'Reporting Time: Daily / Offline',
      'Distinctive decor catalog with low competition',
    ]
  };
            ...
            <div className="lg:w-[38%] bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 text-[#1A3C34] shadow-2xl border border-[#E8E2D6] flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    window.open(
                      "https://analytics.trackier.io/publisher/campaign/4699",
                      "_blank",
                      "noopener,noreferrer"
                    )
                  }
            ...
            <div className="bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 border border-[#E8E2D6] shadow-sm space-y-6">
              <div className="space-y-2">
                ...
                <h2 className="text-2xl sm:text-3xl font-black font-display text-[#1A3C34]">
                  Thoughtfully Crafted Home Decor & Furnishings
                </h2>
              </div>
      ...
      <section className="bg-[#1A3C34] text-white py-20 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10 space-y-6">
          ...
          <p className="text-sm sm:text-base text-[#F5F0E8]/90 font-medium leading-relaxed max-w-xl mx-auto">
            Join CloudsLink and start promoting Sanskriti Homes' distinctive decor collection while earning commissions on qualifying sales.
          </p>
