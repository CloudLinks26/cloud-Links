...
export default function FraganoteContent() {
  // Fraganote Brand Data
  const brand = {
    name: 'Fraganote',
    slug: 'fraganote-affiliate-program',
    logo: 'https://res.cloudinary.com/couponsbit/image/upload/v1786965785/7_dv9gtm.jpg',
    tagline: 'Scent, Signed by You',
    category: 'Fragrances',
    type: 'CPS', // Cost Per Sale
    commission: '8%',
    rating: 4.6,
    country: 'India 🇮🇳',
    about: 'Fraganote is a fragrance brand offering a curated selection of perfumes and scents crafted for everyday wear. With an affordable-luxury positioning, Fraganote appeals to a wide audience discovering premium fragrances at accessible prices.',
    highlights: [
      '8% commission on every qualifying sale',
      'Reporting Time: 72 Hours / Offline',
      'Popular gifting category with strong seasonal demand',
    ]
  };
            ...
            <div className="lg:w-[38%] bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 text-[#1A3C34] shadow-2xl border border-[#E8E2D6] flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    window.open(
                      "https://analytics.trackier.io/publisher/campaign/4945",
                      "_blank",
                      "noopener,noreferrer"
                    )
                  }
            ...
            <div className="bg-[#FDFAF4] rounded-3xl p-6 sm:p-8 border border-[#E8E2D6] shadow-sm space-y-6">
              <div className="space-y-2">
                ...
                <h2 className="text-2xl sm:text-3xl font-black font-display text-[#1A3C34]">
                  Affordable Luxury Fragrances for Everyday Wear
                </h2>
              </div>
      ...
      <section className="bg-[#1A3C34] text-white py-20 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10 space-y-6">
          ...
          <p className="text-sm sm:text-base text-[#F5F0E8]/90 font-medium leading-relaxed max-w-xl mx-auto">
            Join CloudsLink and start promoting Fraganote's curated fragrance collection while earning commissions on qualifying sales.
          </p>
